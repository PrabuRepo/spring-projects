...
public class Graph {
	public static void main(String[] args) {
		/*GraphIntf graphMatrix = new GraphImpl().new GraphAdjMatrix();
		CommonUtil.testGraph(graphMatrix);
		*/
		GraphIntf graphAdjList = new Graph().new GraphAdjList();
		CommonUtil.testGraph(graphAdjList);

		/*GraphIntf graphAdjMap = new GraphImpl().new GraphAdjListUsingMap();
		CommonUtil.testGraph(graphAdjMap);
		
		GraphIntf graphEdgeList = new GraphImpl().new GraphEdgeList();
	 ...
	 * column.
	 */
	class GraphAdjMatrix implements GraphIntf {
		int N;
		int[][] adjMatrix;
	 ...
	 * vertices
	 */
	class GraphAdjList implements GraphIntf {
		int N;
	...
	class GraphAdjListUsingMap implements GraphIntf {
	 ...
	 * about the vertex.
	 */
	class GraphEdgeList implements GraphIntf {
	...
	static class CommonUtil {
		...
		public static void testGraph(GraphIntf graph) {
